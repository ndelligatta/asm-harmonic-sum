...
gcc -c -Wall -o statistics.o -m64 -no-pie -fno-pie statistics.c
g++ -c -m64 -Wall -no-pie -o isfloat.o isfloat.cpp -std=c++17 
g++ -c -m64 -Wall -no-pie -o reciprocal_sum.o reciprocal_sum.cpp -std=c++17

echo "Link 2 object files"
gcc -m64 statistics.o harmonic.o isfloat.o reciprocal_sum.o -fno-pie -no-pie -o my.out
